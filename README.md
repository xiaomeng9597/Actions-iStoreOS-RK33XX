...
[![iStore使用文档](https://img.shields.io/badge/使用文档-iStore%20OS-brightgreen?style=flat-square)](https://doc.linkease.com/zh/guide/istoreos) [![最新固件下载](https://img.shields.io/github/v/release/xiaomeng9597/iStoreOS-For-RK33XX?style=flat-square&label=最新固件下载)](../../releases/latest)
...
- 请把要加入的插件配置填写在仓库 “configfiles/config_data2.txt” 文件里面，假如你直接填写到 “rk33xx/.config” 文件里面绝对会丢你新加的配置，因为每天定时执行同步文件工作流会自动更新.config为istoreos官方最新的配置文件。
...
-微信-
# <img src="https://jihulab.com/xiaomeng9597/webfiles/-/raw/main/weixin.jpg?inline=true" alt="微信收款码" title="Title" width="200" />
